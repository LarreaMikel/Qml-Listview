...
UBUNTU_TRANSLATION_DOMAIN="qml-listview.larreamikel"
...
aptest.commands = bash $$PWD/Qml-Listview/tests/autopilot/run
aptest.depends  = sub-Qml-Listview

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Qml-Listview/tests/unit 
unittest.depends  = sub-Qml-Listview
